                                ...
                                <tbody>
                                    @foreach ($transactions as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="nowrap">Rp
                                                    {{ number_format($item->total_price, 0, ',', '.') }}</span></td>
                                            <td><span class="tag {{ $statusClass }}">{{ $item->rent_status }}</span></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a href="#" class="table-link action-link"
                                                    style="color: #16a34a;">&#10003; Verif</a>
                                                <a href="#" class="table-link action-link"
                                                    style="color: #dc2626;">&#10005; Tolak</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
