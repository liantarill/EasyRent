        ...
        <div class="flex-1 bg-linear-to-br from-gray-50 via-white to-gray-100">
            ...
            <div class="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
                <div class="max-w-6xl mx-auto px-6 py-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-4xl font-black text-gray-900 tracking-tight">Edit Kendaraan</h1>
                            <p class="text-gray-600 mt-2 font-light">Ubah detail kendaraan</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto px-6 py-12">
                ...
                <form action="{{ route('admin.vehicles.update', $vehicle->id) }}" method="POST"
                    enctype="multipart/form-data" class="bg-white rounded-2xl shadow-lg p-8 border-0">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="vehicle_type" required
                                    ...
                                    <option value="car" @selected(old('vehicle_type', $vehicle->vehicle_type) === 'car')>Mobil</option>
                                    <option value="motorcycle" @selected(old('vehicle_type', $vehicle->vehicle_type) === 'motorcycle')>Motor</option>
                                    <option value="truck" @selected(old('vehicle_type', $vehicle->vehicle_type) === 'truck')>Truk</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="transmission" required
                                    ...
                                    <option value="automatic" @selected(old('transmission', $vehicle->transmission) === 'automatic')>Otomatis</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="fuel_type" required
                                    ...
                                    <option value="gasoline" @selected(old('fuel_type', $vehicle->fuel_type) === 'gasoline')>Bensin</option>
                                    <option value="diesel" @selected(old('fuel_type', $vehicle->fuel_type) === 'diesel')>Diesel</option>
                                    <option value="electric" @selected(old('fuel_type', $vehicle->fuel_type) === 'electric')>Listrik</option>
                            ...
                            <div>
                                ...
                                <select name="status" required
                                    ...
                                    <option value="Rented" @selected(old('status', $vehicle->status) === 'Rented')>Disewa</option>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="5"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-100 transition-all duration-300">{{ old('description', $vehicle->description) }}</textarea>
